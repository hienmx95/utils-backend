...
namespace Utils.Handlers
{
    public class ConsumeRabbitMQHostedService : BackgroundService
    {
        ...
        public ConsumeRabbitMQHostedService(IPooledObjectPolicy<IModel> objectPolicy, IConfiguration Configuration, IHubContext<UserNotificationHub> SignalR)
        {
            ...
            foreach (IHandler handler in Handlers)
            {
                ...
                if (handler is AppUserNotificationHandler)
                {
                    ((AppUserNotificationHandler)handler).SignalR = SignalR;
                }    
            }
        ...
        private async Task HandleMessage(string routingKey, string content)
        {
            ...
            IUOW UOW = new UOW(DataContext, Configuration);
